...
import audio from "../assets/quack_sound_effect.mp3";
...
useEffect(()=>{
    ...
    const oneNewOrder = () =>{
        console.log("New Order Received On Socket");
    ...
    socket.on("order : new",oneNewOrder);

    return ()=>{
        socket.off("order : new",oneNewOrder);
    }
...
const completeOrders = orders.filter((o)=>!ACTIVE_STATUSES.includes(o.status));
