...
if(!order)
{
  ...
  return (
    <div className="mx-auto max-w-3xlpx-4 py-6 space-y-6">
...
</div>
{
    (order.status==="rider_assigned" || order.status==="picked_up") && (riderLocation ? (
        <UserMap riderLocation={riderLocation} deliveryLocation ={[order.deliveryAddress.latitude! , order.deliveryAddress.longitude!]}/>
    ) : (
