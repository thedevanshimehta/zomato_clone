...
<div className="w-full bg-white shadow-sm">
    ...
    <div className="flex items-center gap-4">
        <Link to={"/cart"} className="relative"> <CgShoppingCart className="h-6 w-6 text-[#E23744]"/>
        ...
        {/* search bar */}
        {
            isHomePage && (<div className="border-t px-4 py-3">
                <div className="mx-auto flex max-w-7xl items center rounded-lg border shadow-sm">
                    <div className="flex items-center gap-4 px-3 border-r text-gray-700">
...
//searchbar - only available on Home page